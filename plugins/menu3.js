...
`
    ...
    let header = conn.menu.header || '┏━━°☢︎︎❬ %category ❭☢︎︎°━━┓'

    let body   = conn.menu.body   || '┣➥ *٬࿊⃟🤡* %cmd%islimit'
   ...
   ppbotnya = 'https://telegra.ph/file/04983ab978320c0c1b822.jpg' 
...
const freply =     {
	...
	"url": "https://youtu.be/_De5EgwBPM8" ,

	"priceAmount1000": "9999999"

						},

						"businessOwnerJid": "18589527504@s.whatsapp.net"
